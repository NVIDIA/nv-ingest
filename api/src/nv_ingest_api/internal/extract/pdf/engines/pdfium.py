    ...
    try:
        ...
        for page_idx, page_element in page_element_results:
            ...
            if page_element.type_string == "table":
                page_element.content_format = custom_ocr_output_format
...
def pdfium_extractor(
    ...
    try:
        ...
        raise ValueError(
            f"Invalid custom_ocr_output_format: {custom_ocr_output_format_str}. "
