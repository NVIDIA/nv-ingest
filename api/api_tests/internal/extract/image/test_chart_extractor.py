...
class TestExtractChartDataFromImageInternal(unittest.TestCase):
    ...
    def test_no_matching_rows(self, mock_update_chart_metadata, mock_create_clients):
        ...
        mock_create_clients.return_value = (self.mock_yolox_client, self.mock_ocr_client)
        ...
        mock_create_clients.assert_called_once_with(
            ...
            self.extraction_config.endpoint_config.ocr_endpoints,
            self.extraction_config.endpoint_config.ocr_infer_protocol,
        ...
        self.mock_ocr_client.close.assert_called_once()
