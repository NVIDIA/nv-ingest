...
from nv_ingest_api.interface.extract import extract_infographic_data_from_image, extract_table_data_from_image
...
def test_extract_table_data_from_image_integration():
    ...
    for idx, row in df_result.iterrows():
        ...
        assert table_metadata.get("table_content"), f"Row {idx} table_content should not be empty"
