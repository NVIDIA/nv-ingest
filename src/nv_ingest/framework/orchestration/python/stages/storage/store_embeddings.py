...
class PythonEmbeddingStorageStage(PythonStage):
    """
    A Python stage that stores text embeddings in MinIO.
    ...
    def on_data(self, control_message: Any) -> Any:
        ...
        IngestControlMessage
            The updated message with stored embeddings.
        """
        self._logger.debug("PythonEmbeddingStorageStage.on_data: Starting embedding storage process.")
        ...
        self._logger.info("Embedding storage completed. Resulting DataFrame has %d rows.", len(new_df))
        ...
        self._logger.debug("PythonEmbeddingStorageStage.on_data: Embedding storage completed.")
