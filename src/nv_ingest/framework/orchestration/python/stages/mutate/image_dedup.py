...
class PythonImageDedupStage(PythonStage):
    """
    A Python stage that deduplicates images within a DataFrame payload.
    ...
    def on_data(self, control_message: Any) -> Any:
        ...
        IngestControlMessage
            The updated message with deduplicated images.
        """
        self._logger.debug("PythonImageDedupStage.on_data: Starting image deduplication process.")
        ...
        self._logger.info("Image deduplication completed. Resulting DataFrame has %d rows.", len(new_df))
        ...
        self._logger.debug("PythonImageDedupStage.on_data: Image deduplication completed.")
