...
class PythonPDFExtractorStage(PythonStage):
    """
    A Python stage that extracts PDF primitives from a DataFrame payload.
    ...
    def __init__(self, config: PDFExtractorSchema, stage_name: Optional[str] = None) -> None:
        ...
        try:
            ...
            logger.info("PythonPDFExtractorStage configuration validated successfully.")
    ...
    def on_data(self, control_message: Any) -> Any:
        ...
        logger.info("PythonPDFExtractorStage.on_data: Starting PDF extraction process.")
