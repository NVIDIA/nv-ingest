...
def setup_ingestion_pipeline(
    ...
    # image_extractor_stage =
    # add_image_extractor_stage(pipe, morpheus_pipeline_config, ingest_config, default_cpu_count)
    # docx_extractor_stage =
    # add_docx_extractor_stage(pipe, morpheus_pipeline_config, ingest_config, default_cpu_count)
    # pptx_extractor_stage =
    # add_pptx_extractor_stage(pipe, morpheus_pipeline_config, ingest_config, default_cpu_count)
    ########################################################################################################
    ...
    # table_extraction_stage =
    # add_table_extractor_stage(pipe, morpheus_pipeline_config, ingest_config, default_cpu_count)
    # chart_extraction_stage =
    # add_chart_extractor_stage(pipe, morpheus_pipeline_config, ingest_config, default_cpu_count)
    ...
    pipe.add_edge(pdf_extractor_stage, sink_stage)
