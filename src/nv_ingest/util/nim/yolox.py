...
def prepare_images_for_inference(images: List[np.ndarray]) -> np.ndarray:
    ...
    image_array_uint8 = (images[-1]).astype(np.uint8)

    # Specify the file paths
    output_path_png = '/workspace/image_array_pre_resize.png'
    output_path_jpeg = '/workspace/image_array_pre_resize.jpeg'
    ...
    image_array_uint8 = (resized_images[-1]).astype(np.uint8)

    # Specify the file paths
    output_path_png = '/workspace/image_array_post_resize.png'
    output_path_jpeg = '/workspace/image_array_post_resize.jpeg'
