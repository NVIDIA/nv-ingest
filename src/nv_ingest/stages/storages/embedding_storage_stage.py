...
from nv_ingest.modules.storages.embedding_storage import EmbeddingStorageLoaderFactory

logger = logging.getLogger(__name__)


class EmbeddingStorageStage(PassThruTypeMixin, SinglePortStage):
    """
    Stores images.
    ...
    def __init__(
        ...
        self._module_loader: ModuleLoader = EmbeddingStorageLoaderFactory.get_instance(module_name, module_config)

    @property
    def name(self) -> str:
        return "embedding-storage"
