...
| nimOperator.nemoretriever_ocr_v1.image.repository | string | `"nvcr.io/nim/nvidia/nemoretriever-ocr-v1"` |  |
| nimOperator.nemoretriever_ocr_v1.image.tag | string | `"1.2.1"` |  |
