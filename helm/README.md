...
helm upgrade \
    --install \
    nv-ingest \
    https://helm.ngc.nvidia.com/nvidia/nemo-microservices/charts/nv-ingest-25.6.1.tgz \
    -n ${NAMESPACE} \
    --username '$oauthtoken' \
...
pip install nv-ingest-client==25.6.1
```
