...
| nimOperator.llama_3_1_nemotron_nano_vl_8b_v1.authSecret | string | `"ngc-api"` |  |
| nimOperator.llama_3_1_nemotron_nano_vl_8b_v1.enabled | bool | `false` |  |
| nimOperator.llama_3_1_nemotron_nano_vl_8b_v1.expose.service.grpcPort | int | `8001` |  |
| nimOperator.llama_3_1_nemotron_nano_vl_8b_v1.expose.service.port | int | `8000` |  |
| nimOperator.llama_3_1_nemotron_nano_vl_8b_v1.expose.service.type | string | `"ClusterIP"` |  |
| nimOperator.llama_3_1_nemotron_nano_vl_8b_v1.image.pullPolicy | string | `"IfNotPresent"` |  |
| nimOperator.llama_3_1_nemotron_nano_vl_8b_v1.image.pullSecrets[0] | string | `"ngc-secret"` |  |
| nimOperator.llama_3_1_nemotron_nano_vl_8b_v1.image.repository | string | `"nvcr.io/nim/nvidia/llama-3.1-nemotron-nano-vl-8b-v1"` |  |
| nimOperator.llama_3_1_nemotron_nano_vl_8b_v1.image.tag | string | `"latest"` |  |
| nimOperator.llama_3_1_nemotron_nano_vl_8b_v1.replicas | int | `1` |  |
| nimOperator.llama_3_1_nemotron_nano_vl_8b_v1.resources.limits."nvidia.com/gpu" | int | `1` |  |
| nimOperator.llama_3_1_nemotron_nano_vl_8b_v1.storage.pvc.create | bool | `true` |  |
| nimOperator.llama_3_1_nemotron_nano_vl_8b_v1.storage.pvc.size | string | `"300Gi"` |  |
| nimOperator.llama_3_1_nemotron_nano_vl_8b_v1.storage.pvc.volumeAccessMode | string | `"ReadWriteMany"` |  |
...
| nimOperator.page_elements.image.repository | string | `"nvcr.io/nim/nvidia/nemoretriever-page-elements-v2"` |  |
| nimOperator.page_elements.image.tag | string | `"1.6.0"` |  |
