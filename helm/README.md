...
| env[0].name | string | `"INGEST_LOG_LEVEL"` |  |
| env[0].value | string | `"DEFAULT"` |  |
| env[10].name | string | `"MINIO_BUCKET"` |  |
| env[10].value | string | `"nv-ingest"` |  |
| env[11].name | string | `"PADDLE_GRPC_ENDPOINT"` |  |
| env[11].value | string | `"nv-ingest-paddle:8001"` |  |
| env[12].name | string | `"PADDLE_HTTP_ENDPOINT"` |  |
| env[12].value | string | `"http://nv-ingest-paddle:8000/v1/infer"` |  |
| env[13].name | string | `"PADDLE_INFER_PROTOCOL"` |  |
| env[13].value | string | `"grpc"` |  |
| env[14].name | string | `"NEMORETRIEVER_PARSE_HTTP_ENDPOINT"` |  |
| env[14].value | string | `"http://nim-vlm-text-extraction-nemoretriever-parse:8000/v1/chat/completions"` |  |
| env[15].name | string | `"NEMORETRIEVER_PARSE_INFER_PROTOCOL"` |  |
| env[15].value | string | `"http"` |  |
| env[16].name | string | `"YOLOX_GRPC_ENDPOINT"` |  |
| env[16].value | string | `"nemoretriever-page-elements-v2:8001"` |  |
| env[17].name | string | `"YOLOX_HTTP_ENDPOINT"` |  |
| env[17].value | string | `"http://nemoretriever-page-elements-v2:8000/v1/infer"` |  |
| env[18].name | string | `"YOLOX_INFER_PROTOCOL"` |  |
| env[18].value | string | `"grpc"` |  |
| env[19].name | string | `"YOLOX_GRAPHIC_ELEMENTS_GRPC_ENDPOINT"` |  |
| env[19].value | string | `"nemoretriever-graphic-elements-v1:8001"` |  |
| env[1].name | string | `"INGEST_EDGE_BUFFER_SIZE"` |  |
| env[1].value | string | `"64"` |  |
| env[20].name | string | `"YOLOX_GRAPHIC_ELEMENTS_HTTP_ENDPOINT"` |  |
| env[20].value | string | `"http://nemoretriever-graphic-elements-v1:8000/v1/infer"` |  |
| env[21].name | string | `"YOLOX_GRAPHIC_ELEMENTS_INFER_PROTOCOL"` |  |
| env[21].value | string | `"grpc"` |  |
| env[22].name | string | `"YOLOX_TABLE_STRUCTURE_GRPC_ENDPOINT"` |  |
| env[22].value | string | `"nemoretriever-table-structure-v1:8001"` |  |
| env[23].name | string | `"YOLOX_TABLE_STRUCTURE_HTTP_ENDPOINT"` |  |
| env[23].value | string | `"http://nemoretriever-table-structure-v1:8000/v1/infer"` |  |
| env[24].name | string | `"YOLOX_TABLE_STRUCTURE_INFER_PROTOCOL"` |  |
| env[24].value | string | `"grpc"` |  |
| env[25].name | string | `"EMBEDDING_NIM_ENDPOINT"` |  |
| env[25].value | string | `"http://nv-ingest-embedqa:8000/v1"` |  |
| env[26].name | string | `"EMBEDDING_NIM_MODEL_NAME"` |  |
| env[26].value | string | `"nvidia/llama-3.2-nv-embedqa-1b-v2"` |  |
| env[27].name | string | `"MILVUS_ENDPOINT"` |  |
| env[27].value | string | `"http://nv-ingest-milvus:19530"` |  |
| env[28].name | string | `"VLM_CAPTION_ENDPOINT"` |  |
| env[28].value | string | `"https://ai.api.nvidia.com/v1/gr/meta/llama-3.2-11b-vision-instruct/chat/completions"` |  |
| env[29].name | string | `"VLM_CAPTION_MODEL_NAME"` |  |
| env[29].value | string | `"meta/llama-3.2-11b-vision-instruct"` |  |
| env[2].name | string | `"MAX_INGEST_PROCESS_WORKERS"` |  |
| env[2].value | string | `"16"` |  |
| env[30].name | string | `"AUDIO_GRPC_ENDPOINT"` |  |
| env[30].value | string | `"audio:50051"` |  |
| env[31].name | string | `"AUDIO_INFER_PROTOCOL"` |  |
| env[31].value | string | `"grpc"` |  |
| env[32].name | string | `"COMPONENTS_TO_READY_CHECK"` |  |
| env[32].value | string | `"ALL"` |  |
| env[33].name | string | `"MODEL_PREDOWNLOAD_PATH"` |  |
| env[33].value | string | `"/workspace/models/"` |  |
| env[3].name | string | `"NV_INGEST_MAX_UTIL"` |  |
| env[3].value | string | `"48"` |  |
| env[4].name | string | `"MESSAGE_CLIENT_HOST"` |  |
| env[4].value | string | `"nv-ingest-redis-master"` |  |
| env[5].name | string | `"MESSAGE_CLIENT_PORT"` |  |
| env[5].value | string | `"6379"` |  |
| env[6].name | string | `"REDIS_INGEST_TASK_QUEUE"` |  |
| env[6].value | string | `"ingest_task_queue"` |  |
| env[7].name | string | `"NV_INGEST_DEFAULT_TIMEOUT_MS"` |  |
| env[7].value | string | `"1234"` |  |
| env[8].name | string | `"MINIO_INTERNAL_ADDRESS"` |  |
| env[8].value | string | `"nv-ingest-minio:9000"` |  |
| env[9].name | string | `"MINIO_PUBLIC_ADDRESS"` |  |
| env[9].value | string | `"http://localhost:9000"` |  |
