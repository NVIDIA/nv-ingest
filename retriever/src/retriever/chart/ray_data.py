...
def extract_chart_data_ray_data(
    ds: "ray.data.Dataset",
    *,
    ...
    """Ray Data adapter for chart extraction (mutates metadata in-place)."""
    ...
    def _map_batch(batch: pd.DataFrame) -> pd.DataFrame:
        ...
        out, _info = extract_chart_data_from_primitives_df(
            batch,
    ...
    logger.info("Running Ray Data chart extraction: batch_size=%s", batch_size)
