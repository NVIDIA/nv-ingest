...
class SimpleClient(MessageBrokerClientBase):
    ...
    def submit_message(self, queue_name: str, message: str, timeout: Optional[float] = 100,
                       for_nv_ingest: bool = False) -> ResponseSchema:
        return self._handle_push(queue_name, message, timeout, for_nv_ingest)

    def fetch_message(self, queue_name: str, timeout: Optional[float] = 100) -> ResponseSchema:
