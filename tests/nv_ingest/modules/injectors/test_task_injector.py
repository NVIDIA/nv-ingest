...
try:
    from nv_ingest.framework.morpheus.modules.injectors.task_injection import on_data
...
@pytest.fixture
def mock_message():
    """Fixture to create and return a mock IngestControlMessage object."""
    return MagicMock()
...
def test_on_data_calls_get_metadata_with_correct_arguments(mock_message):
    """Test that on_data calls get_metadata on the IngestControlMessage object with correct arguments."""
