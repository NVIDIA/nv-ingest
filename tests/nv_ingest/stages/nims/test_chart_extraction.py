...
from nv_ingest.framework.orchestration.morpheus.stages.nim.chart_extraction import (
    _update_metadata,
    _create_clients,
    _extract_chart_data,
)
...
MODULE_UNDER_TEST = "nv_ingest.framework.orchestration.morpheus.stages.nim.chart_extraction"
