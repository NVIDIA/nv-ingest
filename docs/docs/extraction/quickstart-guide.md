...
5. For faster OCR performance, you can use the [nemoretriever-ocr-v1](https://build.nvidia.com/nvidia/nemoretriever-ocr-v1) container. [Helm](https://github.com/nvidia/nv-ingest/tree/main/helm) is configured to use nr-ocr by default. Set the following values in your .env file:
