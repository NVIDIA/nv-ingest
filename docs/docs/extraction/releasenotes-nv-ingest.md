...
- Support is now deprecated for [paddleocr](https://build.nvidia.com/baidu/paddleocr/modelcard). Use [nemotron-parse](https://build.nvidia.com/nvidia/nemotron-parse/modelcard) instead. For details, refer to [Advanced Visual Parsing](nemoretriever-parse.md).
