...
|----------------------------------|--------------------------------|-----------------------------------------------------------------------|
| `DOWNLOAD_LLAMA_TOKENIZER`       | -                                                        | Pre-download the default tokenizer at build time. For details, refer to [Llama tokenizer (default)](chunking.md#llama-tokenizer-default). |
| `HF_ACCESS_TOKEN`                | -                                                         | A token to access HuggingFace models. For details, refer to [Llama tokenizer (default)](chunking.md#llama-tokenizer-default). |
