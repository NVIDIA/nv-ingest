...
# Optional: graph view for process tree
try:
                                                                ...
                                                                html.Div(
                                                                    [
                                                                        ...
                                                                        dcc.Input(
                                                                            id="proctree-search",
                                                                            type="text",
                                                                            placeholder="e.g. microservice_entrypoint.py",
                                                                            debounce=False,
                                                                            style={
                                                                                "width": "320px",
                                                                                "marginLeft": "6px",
                                                                        ...
                                                                        html.Div(
                                                                            "Type to search; select a row to populate Root PID.",
                                                                            className="muted",
                                                                            style={"marginTop": "6px"},
                                                                        ),
                                                                        html.Div(
                                                                    ...
                                                                    [
                                                                        (
                                                                            ...
                                                                            if CY_AVAILABLE
                                                                                ...
                                                                                "Graph view requires dash-cytoscape. Install with: pip install dash-cytoscape",
                                                                                className="muted",
                                                                                style={"padding": "8px"},
                                                                            )
                                                                        )
